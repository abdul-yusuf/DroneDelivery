...
title = CampusDroneDelivery

# (str) Package name
package.name = DivTech
...
#presplash.filename = %(source.dir)s/assets/logo/android-chrome-192x192.png
...
#android.presplash_lottie = %(source.dir)s/Animation_lotif.json
